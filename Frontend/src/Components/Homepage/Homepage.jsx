      ...
      <section className="intro-section">
        <div className="intro-content">
          ...
          <div className="intro-text-container">
            <p>
              We're building an <em>Integrated Campus Wellness Platform</em> not
              just an app.
            </p>
            <p>
              <strong>For students</strong>, it's a hub with an AI Chatbot,
              confidential counsellor booking, and mental health resources.
            </p>
            <p>
              <strong>For administration</strong>, it provides an{" "}
              <em>Anonymous Data Dashboard</em> to track and improve campus
              well-being.
            </p>
          </div>
        </div>
        ...
        <div className="challenges-container">
          ...
          <div className="challenge-item">
            ...
            <p className="challenge-desc">
              Students fear being labeled "weak" or "crazy," hindering
              help-seeking.
            </p>
            <p className="solution-desc">
              👉 With ThinkFit, support is private, stigma-free, and
              judgment-free.
            </p>
          </div>
          ...
          <div className="challenge-item">
            ...
            <p className="challenge-desc">
              Few counselors on campus, especially in rural areas, make
              appointments difficult.
            </p>
            <p className="solution-desc">
              👉 ThinkFit provides 24/7 digital access, ensuring help is always
              within reach.
            </p>
          </div>
          ...
          <div className="challenge-item">
            ...
            <p className="challenge-desc">
              Many students are unaware of college mental health services or
              normalize distress.
            </p>
            <p className="solution-desc">
              👉 ThinkFit offers Awareness through access, reminders, and
              self-help.
            </p>
          </div>
          ...
          <div className="challenge-item">
            ...
            <p className="challenge-desc">
              Colleges often react only after serious incidents, lacking
              real-time mental health data.
            </p>
            <p className="solution-desc">
              👉 ThinkFit offers proactive tracking and insights for early
              interventions.
            </p>
          </div>
          ...
          <div className="challenge-item">
            ...
            <p className="challenge-desc">
              Existing apps are often Western-focused, paid, and lack local
              language support.
            </p>
            <p className="solution-desc">
              👉 ThinkFit offers Affordable, multilingual, student-focused
              support.
            </p>
          </div>
          <div className="challenge-item">
            ...
            <p className="solution-desc">
              👉 ThinkFit builds resilience and mindfulness practices handle
              pressure.
            </p>
          </div>

          <p className="result-text">
            ✨ <strong>Result:</strong> By removing these barriers, ThinkFit
            ensures students access the right support at the right time, leading
            to healthier, happier, and more productive lives.
          </p>
        </div>
      </section>
      ...
      <div className="landing-page">
          ...
          <div className="hero-content">
            <div className="hero-text">
              <div className="tagline">
                <span role="img" aria-label="heart" className="icon">
                  ❤️
                </span>
                ...
                <div className="role-card" id="user-role-card">
                  <div className="card-header">
                    <div className="icon-circle">
                      <span role="img" aria-label="users" className="icon-lg">
                        👥
                      </span>
                    </div>
                    <h3 className="card-title">I need support</h3>
                    <p className="card-description">
                      Book sessions with licensed counselors and access
                      AI-powered support
                    </p>
                  </div>
        ...
        <button className="cta-btn">Continue as User</button>
                ...
                <div className="role-card" id="counselor-role-card">
                  <div className="card-header">
                    <div className="icon-circle">
                      <span role="img" aria-label="brain" className="icon-lg">
                        🧠
                      </span>
                    </div>
                    <h3 className="card-title">I'm a counselor</h3>
                    <p className="card-description">
                      Manage your practice and provide professional mental
                      health support
                    </p>
                  </div>
                  <div className="card-content">
                    <div className="card-points">
                      <div className="point">
                        <span role="img" aria-label="users" className="icon-sm">
                          👥
                        </span>
                ...
                <div className="role-card" id="admin-role-card">
                  <div className="card-header">
                    <div className="icon-circle">
                      <span role="img" aria-label="gear" className="icon-lg">
                        ⚙️
                      </span>
                    </div>
                    <h3 className="card-title">Admin Panel</h3>
                    <p className="card-description">
                      Oversee the platform, manage users, and ensure smooth
                      operations
                    </p>
                  </div>
                  <div className="card-content">
        ...
        <section className="features-section">
          <div className="features-container">
            <div className="features-header">
              ...
              <p>
                Professional, secure, and accessible mental health support
            ...
            <div className="features-grid">
              <div className="feature">
                <div className="feature-icon primary">
                  <span role="img" aria-label="shield" className="icon-sm">
                    🛡️
                  </span>
                </div>
              ...
              <div className="feature">
                <div className="feature-icon secondary">
                  <span role="img" aria-label="heart" className="icon-sm">
                    ❤️
                  </span>
                </div>
              ...
              <div className="feature">
                <div className="feature-icon primary">
                  <span role="img" aria-label="chat bubble" className="icon-sm">
                    💬
                  </span>
                </div>
                <h3>24/7 Support</h3>
